# ============================================================
# Day 10: Checking if a subscription exists
# App: In-house Subscription Tracker
# End Goal: High-intermediate Python developer level
# Difficulty Mode: Ground-up but adaptive
# Main Focus: membership checks and booleans
# App Feature: Find a subscription by name
# ============================================================
...
Main idea:
- membership checks and booleans
- App feature: Find a subscription by name
